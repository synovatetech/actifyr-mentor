...
function CreatePasswordContent() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    if (!token) {
      errorToast('Link is missing or invalid. Please use the latest link to create your password.');
      return;
    }
    ...
    try {
      ...
      errorToast(response.error || 'Unable to create password. Please try again.');
    } catch (err) {
      errorToast('Unable to create password. Please try again.');
    } finally {
      setLoading(false);
    }
  };
