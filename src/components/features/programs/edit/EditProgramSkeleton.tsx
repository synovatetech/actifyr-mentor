...
export function EditProgramSkeleton() {
  return (
    <div className={styles.pageWrapper} role="status" aria-label="Loading program">
      {/* Page title */}
      <div className="animate-pulse bg-gray-200" style={{ width: 140, height: 18, borderRadius: 5, marginBottom: 21.6 }} />
      ...
      <div className={styles.form}>
        ...
        {/* ── Set Visibility ──────────────────────── */}
        <SkeletonSection>
          <div className="animate-pulse bg-gray-200" style={{ width: 220, height: 16, borderRadius: 4, marginBottom: 21.6 }} />
