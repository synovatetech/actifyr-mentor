...
export const BACKEND_BASE_URL =
  process.env.NEXT_PUBLIC_API_BASE_URL || 'https://api.actifyr.com';
...
export function setAuthCookies(
  ...
  response.cookies.set('token', tokens.accessToken, cookieOptions(ACCESS_TOKEN_MAX_AGE));
  if (tokens.refreshToken) {
    response.cookies.set('refresh_token', tokens.refreshToken, cookieOptions(REFRESH_TOKEN_MAX_AGE));
  }
}
